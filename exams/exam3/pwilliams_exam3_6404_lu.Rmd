...
knitr::kable(head(adat[,c('mpg','cyl','disp','accel','name'),with=F]), col.names = c('MPG','Cylinder Count','Displacement','Acceleration','Model'), caption = 'Preview of Automobile MPG Dataset (Published 1993)')
```
