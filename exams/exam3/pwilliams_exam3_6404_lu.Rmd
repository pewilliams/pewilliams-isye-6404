...
*Note: Due to the computation overhead and instability of the kernel regression fits from the np package, and instability of fits from smooth.spline in R (base), bootstrap confidence intervals were computed based on a limited B = 1000 replications.*
